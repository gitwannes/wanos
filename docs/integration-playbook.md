...
| **G10 HomeWizard** | Local P1 / kWh / sockets | **Done** — Pi smoke **2026-09-10** (P1 + PV; sockets deferred); health **G21** ✅ **2026-09-22** (poll-staleness + shared session + 3-fail hysteresis) — [`integration_homewizard.md`](integration_homewizard.md); scout `helpers/homewizard_discovery.py`; map UI → **G17** |
